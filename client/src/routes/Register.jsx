...
function Register() {
  ...
  return (
    <div className='flex justify-center items-center w-full h-screen bg-gradient-to-bl from-primary via-primary to-secondary'>
      ...
      <div className='w-6/12 h-4/6 rounded backdrop-blur-xl bg-white/20 flex flex-col items-center p-3'>
        ...
        <form className='flex flex-col items-center h-2/3 mt-5 w-full' onSubmit={handleSubmit}>
          ...
          <Input name={'confirmpw'} labelText={'Confirm your password'} handleChange={(e) => isMatching(e)} type={'password'} />
